...
#pragma warning disable CS8767 // Nullability of reference types in type of parameter doesn't match implicitly implemented member (possibly because of nullability attributes).
    ...
    internal sealed class BoolToStringConverter : IValueConverter
    {
        ...
        {
            return ThrowHelper.NotImplementedException<object>("ConvertBack method for BoolToStringConverter is not implemented.");
        }
    }
    ...
    internal sealed class BoolToColorConverter : IValueConverter
    {
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return ThrowHelper.NotImplementedException<object>("ConvertBack method for BoolToColorConverter is not implemented.");
        }
    }
    ...
    internal sealed class ImagePathToBitmapConverter : IValueConverter
    {
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return ThrowHelper.NotImplementedException<object>("ConvertBack method for ImagePathToBitmapConverter is not implemented.");
        }
    }
