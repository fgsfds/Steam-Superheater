...
namespace Database.Server.Migrations
{
    ...
    [Migration("20241105200532_AddEventsTableGuidColumn")]
    partial class AddEventsTableGuidColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Server.DbEntities.EventTypesDbEntity", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("smallint")
                        .HasColumnName("id");
                    ...
                    b.ToTable("event_types", "main");
                });

            modelBuilder.Entity("Database.Server.DbEntities.EventsDbEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Database.Server.DbEntities.EventsDbEntity", b =>
                {
                    b.HasOne("Database.Server.DbEntities.EventTypesDbEntity", "EventTypesTable")
                        .WithMany()
